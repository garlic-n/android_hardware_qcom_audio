...
enum {
    ...
    SND_DEVICE_IN_HANDSET_MIC  = SND_DEVICE_IN_BEGIN, // 45
    SND_DEVICE_IN_HANDSET_MIC_EXTERNAL,
    SND_DEVICE_IN_HANDSET_MIC_AEC,
    SND_DEVICE_IN_HANDSET_MIC_NS,
    SND_DEVICE_IN_SKYPE_HEADSET_MIC, // 49
    SND_DEVICE_IN_HANDSET_MIC_AEC_NS, // 50
    ...
    SND_DEVICE_IN_SPEAKER_DMIC_AEC_NS, // 62 OK
    ...
    SND_DEVICE_IN_VOICE_HANDSET_REC, // 73
    SND_DEVICE_IN_VOICE_DMIC,
    SND_DEVICE_IN_SKYPE_DMIC, // 75
    ...
    SND_DEVICE_IN_QUAD_MIC, // 89
    SND_DEVICE_IN_HANDSET_STEREO_DMIC, // 90
    ...
    SND_DEVICE_IN_SPEAKER_DMIC_AEC_NS_BROADSIDE, // 97
